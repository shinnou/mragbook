...
import faiss
index = faiss.read_index("data/ibaraki_index.faiss")
...
llm_model = AutoModelForCausalLM.from_pretrained(
    llm_model_name, dtype="auto", device_map="auto"
).eval()
...
rag = SimpleRetrievalQA(llm_model, tokenizer, database, prompt)

query = "日立駅を設計した人は誰ですか？"
# query = "茨城県で最も人気の高い観光地はどこですか？"
