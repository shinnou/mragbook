...
下記の件で[issue](https://github.com/shinnou/mragbook/issues/1)を立てました。反映状況は issue の方から確認できます。終了したら、お知らせします。

（2026年7月21日）

読者の方から正誤の指摘ありました。沢山あるので、以下のページにまとめていただいているようです。ありがとうございました。

https://mirai-tec.hatenablog.com/entry/2026/07/20/112329

ご指摘された点は少しずつになりそうですが、確認して、[正誤表](ERRATA.md)の方に反映していきます。
