...
読者の方から正誤の指摘ありました。沢山あるので、以下のページにまとめていただいているようです。ありがとうございました。またコードの品質が悪いとの注意もありました。私の勉強不足です。すみませんでした。

https://mirai-tec.hatenablog.com/entry/2026/07/20/112329

ご指摘された点は少しずつになりそうですが、確認して、[正誤表](ERRATA.md)の方に反映していきます。（2026年7月21日）
